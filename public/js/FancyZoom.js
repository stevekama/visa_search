...
(function($) {
    ...
    $.fn.fancyZoom = function(settings) {
        ...
        function FancyZoom(opts) {
            ...
            var $zoom, $zoom_img, $zoom_close, $zoom_spin, $caption;
            ...
            function zoomIn(from) {
                ...
                zooming = true;
                $zoom_img.attr("src", $(from).find('img').attr("src"));
                //$caption.html('ÝÊÍ ÇáßÊÇÈ');
                //$caption.attr('href', $(from).attr("href"));

                var endW = $(from).find('img')[0].naturalWidth;
                var endH = $(from).find('img')[0].naturalHeight;
